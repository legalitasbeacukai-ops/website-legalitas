// main.js - shared utilities for multi-page demo
...
// Create letter HTML: reuse the same letter text
    ...
    <div style="margin-top:22px">
      <div style="display:flex;gap:18px;align-items:flex-end">
        <div style="position:relative">
          <img id="stampRender" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Indonesian_coat_of_arms.svg/240px-Indonesian_coat_of_arms.svg.png" alt="stamp" style="width:120px;filter:grayscale(0);opacity:0.95" />
        </div>
...
// attach simple nav behaviour (highlight)
function initNav(){
